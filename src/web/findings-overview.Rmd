...
![](www/RPLOT.png){width=60%}</left> ![](www/mapbefore.png){width=60%}</right> 
...
![median](www/ohiomedian.png){width=45%}</left>  ![mean](www/ohiomean.png){width=45%}</right>
...
![](www/Website/contingency_before.png){width=80%}</center> ![](www/Website/contingency_after.png){width=80%}</center> 
